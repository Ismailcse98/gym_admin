...
<head>
    ...
    <link rel="shortcut icon" href="{{asset('assets/uploads/favicon.png')}}">
        ...
        <div class="header">
            ...
            <div class="header-left">
                <a href="index.html" class="logo">
                    <img src="assets/uploads/logo.png" style="background: #000; padding: 7px; border-radius: 5px;" alt="Logo">
                </a>
                <a href="index.html" class="logo logo-small">
                    <img src="assets/uploads/favicon.png" alt="Logo" width="30" height="30">
                </a>
