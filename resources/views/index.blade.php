                    ...
                    <div class="appointment-item">
                        ...
                        <div class="app-user">
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="app-img">
                                        <img src="assets/img/profiles/avatar-02.jpg" alt="" class="img-fluid">
                                        <div class="app-name">
                                            <h6>Dr. Lester </h6>
                                            <p>Orthopaedics</p>
                                        </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="app-img justify-content-sm-end">
                                        <img src="assets/img/profiles/avatar-05.jpg" alt="" class="img-fluid">
                                        <div class="app-name">
                                            <h6>Chris Harris</h6>
                                            <p>ID : 781212, M</p>
                                        </div>
                    ...
                    <div class="appointment-item">
                        ...
                        <div class="app-user">
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="app-img">
                                        <img src="assets/img/profiles/avatar-06.jpg" alt="" class="img-fluid">
                                        <div class="app-name">
                                            <h6>Dr. Monroe</h6>
                                ...
                                <div class="col-sm-6">
                                    <div class="app-img justify-content-sm-end">
                                        <img src="assets/img/profiles/avatar-07.jpg" alt="" class="img-fluid">
                                        <div class="app-name">
                                            <h6>Bess Twishes</h6>
                                            <p>ID : 787787, M</p>
                                        </div>
                    ...
                    <div class="appointment-item">
                        ...
                        <div class="app-user">
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="app-img justify-content-sm-end">
                                        <img src="assets/img/profiles/avatar-08.jpg" alt="" class="img-fluid">
                                        <div class="app-name">
                                            <h6>James Aaron</h6>
                                            <p>ID : 781212, M</p>
                                        </div>
                        ...
                        <table class="table table-borderless">
                            <tbody>
                                <tr class="speciality-item">
                                    <td class="spl-name">
                                        <div class="spl-box">
                                            <img src="assets/img/icon/urology.png" alt="User Image">
                                        </div>
                                        <div class="spl-count">
                                            <h6>Urology</h6>
                                            <p>Patients : 400</p>
                                ...
                                <tr class="speciality-item">
                                    <td class="spl-name">
                                        <div class="spl-box">
                                            <img src="assets/img/icon/neurology.png" alt="User Image">
                                        </div>
                                        <div class="spl-count">
                                            <h6>Neurology</h6>
                                            <p>Patients : 980 </p>
                                ...
                                <tr class="speciality-item">
                                    <td class="spl-name">
                                        <div class="spl-box">
                                            <img src="assets/img/icon/ortho.png" alt="User Image">
                                        </div>
                                        <div class="spl-count">
                                            <h6>Orthopedic</h6>
                                            <p>Patients : 600</p>
                                ...
                                <tr class="speciality-item">
                                    <td class="spl-name">
                                        <div class="spl-box">
                                            <img src="assets/img/icon/cardio.png" alt="User Image">
                                        </div>
                                        <div class="spl-count">
                                            <h6>Urology</h6>
                                            <p>Patients : 400</p>
                                ...
                                <tr class="speciality-item">
                                    <td class="spl-name">
                                        <div class="spl-box">
                                            <img src="assets/img/icon/dental.png" alt="User Image">
                                        </div>
                                        <div class="spl-count">
                                            <h6>Urology</h6>
                                            <p>Patients : 400</p>
                            ...
                            <div class="appointment-items">
                                <div class="app-user">
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="app-img">
                                                <img src="assets/img/profiles/avatar-09.jpg" alt="" class="img-fluid">
                                                <div class="app-name">
                                                    <h6>Dr. Rayan </h6>
                                                    <p>Orthopaedics</p>
                                                </div>
                            ...
                            <div class="appointment-items">
                                <div class="app-user">
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="app-img">
                                                <img src="assets/img/profiles/avatar-12.jpg" alt="" class="img-fluid">
                                                <div class="app-name">
                                                    <h6>Dr. Alex </h6>
                                                    <p>Orthopaedics</p>
                                                </div>
                            ...
                            <div class="appointment-items">
                                <div class="app-user">
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="app-img">
                                                <img src="assets/img/profiles/avatar-03.jpg" alt="" class="img-fluid">
                                                <div class="app-name">
                                                    <h6>Dr. Shofia </h6>
                                                    <p>Orthopaedics</p>
                                                </div>
                                        ...
                                        <div class="col-6">
                                            <div class="app-img">
                                                <img src="assets/img/profiles/avatar-10.jpg" alt="" class="img-fluid">
                                                <div class="app-name">
                                                    <h6>Harris Chris</h6>
                                                    <p>ID : 781212, M</p>
                                                </div>
